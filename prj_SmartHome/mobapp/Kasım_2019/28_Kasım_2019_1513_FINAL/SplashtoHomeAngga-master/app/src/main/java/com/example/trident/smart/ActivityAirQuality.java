...
public class ActivityAirQuality extends AppCompatActivity {
     ...
     * "Hava Kalitesi"(Kirlilik,Mükemmel,İyi) seç.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AppCompatRadioButton radioButton_Excellent = (AppCompatRadioButton)findViewById(R.id.radioButton_Excellent);
        final AppCompatRadioButton radioButton_Good      = (AppCompatRadioButton)findViewById(R.id.radioButton_Good);
        final AppCompatRadioButton radioButton_Pollution = (AppCompatRadioButton)findViewById(R.id.radioButton_Pollution);
        ...
        if(Static.ITEM_NAME !=null){
            String[] arr = Static.ITEM_NAME.split(":");//Hava kalitesi:Kirlilik
            if(arr[1].equals(getString(R.string.excellent)))
                radioButton_Excellent.setChecked(true);
            else if(arr[1].equals(getString(R.string.good)))
                radioButton_Good.setChecked(true);
            else if(arr[1].equals(getString(R.string.pollution)))
                radioButton_Pollution.setChecked(true);
        }
        ...
        button_Done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(radioButton_Excellent.isChecked() ==false && radioButton_Good.isChecked() == false && radioButton_Pollution.isChecked() == false){
                ...
                String s_value = null;
                if(radioButton_Excellent.isChecked())
                    s_value = getString(R.string.excellent);
                else if(radioButton_Good.isChecked())
                    s_value = getString(R.string.good);
                else if(radioButton_Pollution.isChecked())
                    s_value = getString(R.string.pollution);
                ...
                intent.putExtra(BetweenActivities.item_name,getString(R.string.air_quality));
                ...
                intent.putExtra(BetweenActivities.device_type, DeviceType.AIR_QUALITY);//AIR_QUALITY
                //clear for new:
                Static.makeNull();
        ...
        linearLayout_GoToCurrentCity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(BetweenActivities.where_come_from,"ActivityAirQuality.java");
                startActivity(intent);
            }
        });
        radioButton_Excellent.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                    Static.ITEM_NAME = ":" + radioButton_Excellent.getText(); //add ":" ,because we make split(":") when installing first.
            }
        });
        radioButton_Good.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                    Static.ITEM_NAME = ":" + radioButton_Good.getText();
            }
        });
        radioButton_Pollution.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b)
                    Static.ITEM_NAME = ":" + radioButton_Pollution.getText();
            }
        });
        ///Events:@}
    ...
    private void goToBack(){
        Intent intent = null;
        if(Static.WHERE_COME_FROM.equals("ActivityAirQuality.java"))
