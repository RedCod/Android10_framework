...
///ADD:@{	
	...
	@GET
	@Produces("application/json")
	@Path("/AddAction/{AccountId}/{AccountName}/{AutomationId}/{ActionType}/{DeviceId}/{DeviceVirtualAddress}/{DeviceSwitch}/{AutomationIdAssign}/{TimeLapseValue}/{ItemSort}")
	public Response AddAction(@PathParam("AccountId")int AccountId,
		 ...
		 */
		Automation automation = new Automation();
		String response = automation.addAction(AccountId,AccountName, AutomationId, ActionType, DeviceId, DeviceVirtualAddress, DeviceSwitch, AutomationIdAssign, TimeLapseValue, ItemSort);
		return Response.status(200).entity(response).build();
	}
///ADD:@}	
//////////////////////////////////////////////////////////////////////////////////////////////////
///EDiT:@{
	...
	@GET
	@Produces("application/json")
	@Path("/EditAction/{AccountId}/{AccountName}/{ActionId}/{DeviceVirtualAddress}/{DeviceSwitch}/{AutomationIdAssign}/{TimeLapseValue}/{ItemSort}")
	public Response EditAction(@PathParam("AccountId")int AccountId,
		 ...
		 */
		Automation automation = new Automation();
		String response = automation.editAction(AccountId,AccountName,ActionId, DeviceVirtualAddress, DeviceSwitch, AutomationIdAssign, TimeLapseValue, ItemSort);
		return Response.status(200).entity(response).build();
	}
