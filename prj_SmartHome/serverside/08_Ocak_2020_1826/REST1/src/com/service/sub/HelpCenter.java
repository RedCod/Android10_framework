...
public class HelpCenter {
	 ...
	 */
	public String editHelp(int helpId,String title,String contentPath) {
		String response = "{\"EditHelp\":[{ \"response\":false}]}";
		String update_sql = "UPDATE tblHelpCenter SET Title='" + title + "',ContentPath='" + contentPath + "' WHERE Id='" + helpId + "'";
		Database database = new Database();
		try {
			database.connect();
	 ...
	 */
	public String getItem(int helpId) {
		String query_sql = "SELECT *FROM tblHelpCenter WHERE Id='" + helpId + "'";
		Database database = new Database();
		String content = "{\"Item\":[\n";
		try {
			database.connect();
	 ...
	 */
	public String remove(int helpId) {
		String response = "{\"Remove\":[{ \"response\":false}]}";
		String remove_sql = "DELETE FROM tblHelpCenter WHERE Id='" + helpId + "'";
		Database database = new Database();
		try {
			database.connect();
