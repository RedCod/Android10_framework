...
CREATE TABLE IF NOT EXISTS tblScenarioSub (
	 ...
	 */
	public String editScenario(int scenarioRowId,String scenarioName,int coverImage,int showOnMainPage) {
	 ...
	 */
	public String editScenarioItemSort(int scenarioRowId,int itemSort) {
	 ...
	 */
	public String removeScenario(int scenarioRowId) {
	 ...
	 */
	public String removeScenarioAction(int actionRowId) {
