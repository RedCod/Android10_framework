...
CREATE TABLE IF NOT EXISTS tblDeviceGroupSub (
	 ...
	 */
	public String editGroupName(int rowId,String groupName) {
	 ...
	 * @return				//return true(as JSON) if successful
	 */
	public String editGroupLocation(int rowId,String groupLocation) {
	 ...
	 */
	public String getGroupDevicesAsList(int groupId){
	 ...
	 * @return
	 */
	public String getAllGroupsAsList(int accountId,int familyId) {
	 ...
	 * @return		//return true(as JSON) if successful.
	 */
	public String removeDevice(int rowId) {
		/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	 ...
	 * @return		//return true(as JSON) if successful.
	 */
	public String removeGroup(int rowId) {
