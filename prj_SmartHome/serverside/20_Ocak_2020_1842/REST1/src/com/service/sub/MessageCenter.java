 ...
 */
	 ...
	 */
	public String editMessage(int messageRowId,String message,String messageDateTime,int messageType) {
	 ...
	 */
	public String getItem(int messageRowId) {
	 ...
	 */
	public String removeMessage(int messageRowId) {
