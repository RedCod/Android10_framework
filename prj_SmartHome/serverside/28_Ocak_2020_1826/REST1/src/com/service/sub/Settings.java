...
public class Settings {
	 ...
	 */
	public String addSettings(int accountId,int dontDisturbDevices,int pushNotification) {
	 ...
	 * @return				//return true(as JSON) if successful
	 */
	public String editDontDisturbDevices(int accountId,int stateValue) {
	 ...
	 * @return			 //return true(as JSON) if successful.
	 */
	public String editPushNotification(int accountId,int stateValue) {
	 ...
	 * @return			//return true(as JSON) if successful
	 */
	public String removeSettings(int accountId) {
