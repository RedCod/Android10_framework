...
CREATE TABLE IF NOT EXISTS tblDevice (
	 ...
	 */
	public String editName(int accountId,String accountName,int deviceId,String deviceName) {
	 ...
	 */
	public String editLocation(int accountId,String accountName,int deviceId,int deviceLocation) {
	 ...
	 */
	public String editDeviceSort(int accountId,String accountName,int deviceId,int sortValue) {
	 ...
	 */
	public String getItem(int accountId,String accountName,int deviceId) {
		///for improving security[28120201126]:@{
		if(!Account.accountIsExists(accountId, accountName)){
			return "{\"Item\":[ ]}";
		}
	 ...
	 */
	public String removeDevice(int accountId,String accountName,int deviceId) {
		/*TODO:
