...
CREATE TABLE IF NOT EXISTS tblDontDisturbDevices(
	...
	public String getItem(int id) {
		//String response = "{\"GetItem\":[{ \"response\":\"false\"}]}";
		String query_sql = "SELECT *FROM tblDontDisturbDevices WHERE Id='" + id + "'";
		Database database = new Database();
		String content = "{\"Item\":[\n";
		try {
			database.connect();
	...
	public String edit(int id,
		...
		String update_sql = "UPDATE tblDontDisturbDevices SET TimeStart='" +timeStart+"',TimeEnd='"+timeEnd+"',DevicesId='"+devicesId+"',Monday='"+monday+"',Tuesday='"+tuesday+"',Wednesday='"+wednesday+"',Thursday='"+thursday+"',Friday='"+friday+"',Saturday='"+saturday+"',Sunday='"+sunday+"' WHERE Id='"+id+"'";
		Database database = new Database();
		try {
			database.connect();
	...
	public String remove(int id) {
		...
		String delete_sql = "DELETE FROM tblDontDisturbDevices WHERE Id='" + id + "'";
		Database database = new Database();
		try {
			database.connect();
