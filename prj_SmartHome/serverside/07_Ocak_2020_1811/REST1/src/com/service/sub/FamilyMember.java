...
public class FamilyMember {
	 ...
	 */
	public String editMember(int memberId,int accountIsAdmin) {
		String response = "{\"EditMember\":[{ \"response\":false}]}";
		String insert_sql = "UPDATE tblFamilyMember SET AccountIsAdmin='" + accountIsAdmin + "' WHERE Id='" + memberId + "'";
		Database database = new Database();
		try {
			database.connect();
			int s = database.execSQL(insert_sql);
	 ...
	 */
	public String getItem(int memberId) {
		String query_sql = "SELECT *FROM tblFamilyMember WHERE Id='" + memberId + "'";
		Database database = new Database();
		String content = "{\"Item\":[\n";
		try {
			database.connect();
	...
	public String removeMember(int memberId) {
		...
		String insert_sql = "DELETE FROM tblFamilyMember WHERE Id='" + memberId + "'";
		Database database = new Database();
		try {
			database.connect();
			int s = database.execSQL(insert_sql);
