...
public class WS_Scenario {
	...
	@GET
	@Produces("application/json")
	@Path("/AddScenarioAction/{AccountId}/{AccountName}/{ScenarioId}/{ActionType}/{DeviceId}/{MacAddress}/{DeviceSwitch}/{AutomationId}/{TimeLapseValue}/{ItemSort}")
	public Response AddScenarioAction(@PathParam("AccountId")int AccountId,
									  ...
									  @PathParam("ItemSort")int ItemSort) {
		/*
		 * http://localhost:8080/REST1/Scenario/AddScenarioAction/1/test@gmail.com/1/device/44/macaddress/ON/0/0/1
		 */
		Scenario scenario = new Scenario();
		String response = scenario.addScenarioAction(AccountId,AccountName, ScenarioId, ActionType, DeviceId, MacAddress, DeviceSwitch, AutomationId, TimeLapseValue, ItemSort);
		return Response.status(200).entity(response).build();
	}
	...
	@GET
	@Produces("application/json")
	@Path("/EditScenarioAction/{AccountId}/{AccountName}/{ActionId}/{MacAddress}/{DeviceSwitch}/{AutomationId}/{TimeLapseValue}/{ItemSort}")
    public Response EditScenarioAction(@PathParam("AccountId")int AccountId,
    								   ...
    								   @PathParam("ItemSort")int ItemSort) {
		/*
		 * http://localhost:8080/REST1/Scenario/EditScenarioAction/1/test@gmail.com/2/macaddres/OFF/0/0/2
		 */
		Scenario scenario = new Scenario();
		String response = scenario.editScenarioAction(AccountId,AccountName,ActionId,MacAddress, DeviceSwitch, AutomationId, TimeLapseValue, ItemSort);
		return Response.status(200).entity(response).build();
	}
